...
import { View, Text, ScrollView, RefreshControl, StyleSheet, TouchableOpacity, Platform, Linking } from 'react-native';
...
export default function DeliveryPayouts() {
  ...
  }, [profile?.user_id, fetchPlatformSettings, fetchWallet, fetchLedger, fetchPayoutRequests]);
  ...
  const handleSubmit = async () => {
    ...
    if (res.success) {
      ...
      showAlert('تم بنجاح', 'لقد تم إرسال طلب السحب بنجاح. سيتم مراجعته قريباً.', 'success');
      setAmount('');
      setDetails('');
      setShowForm(false);
      load();
...
const styles = StyleSheet.create({
  ...
  balanceLabel: { fontSize: 12, fontFamily: 'Tajawal_500Medium', marginBottom: 4 },
  ...
  formHint: { ...typography.caption, textAlign: 'center', marginTop: 12, opacity: 0.6 },
