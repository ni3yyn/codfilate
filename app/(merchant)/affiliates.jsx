...
const ExpandedTrustDetails = ({
  ...
  return (
    <View
      style={[styles.expandedContent, { borderTopColor: theme.colors.divider }]}
    >
      {/* Trust Grade Badge */}
      <View
        style={[
      ...
      >
        ...
        <View style={styles.detailRow}>
          <Text style={[styles.detailLabel, { color: getGradeColor("A") }]}>
            طلبات ناجحة (مُوصّلة):
          </Text>
          <Text style={[styles.detailValue, { color: getGradeColor("A") }]}>
            {delivered}
          </Text>
        </View>
        <View style={styles.detailRow}>
          <Text style={[styles.detailLabel, { color: getGradeColor("F") }]}>
            طلبات وهمية / مسترجعة:
          </Text>
          <Text style={[styles.detailValue, { color: getGradeColor("F") }]}>
            {cancelled}
          </Text>
        </View>
      </View>
        ...
        style={[
          styles.toggleBtn,
          {
            backgroundColor: affiliate.is_active
              ? "rgba(214, 48, 49, 0.1)"
              : "rgba(0, 184, 148, 0.1)",
            borderColor: affiliate.is_active
              ? "rgba(214, 48, 49, 0.2)"
              : "rgba(0, 184, 148, 0.2)",
          },
        ]}
...
export default function AffiliatesScreen() {
  ...
  const { affiliates, isLoading, fetchStoreAffiliates, toggleAffiliateStatus } =
    useAffiliateStore();
        ...
        <Card style={styles.card}>
          <View style={styles.row}>
            ...
            <View style={styles.info}>
              ...
              {profile?.phone && (
                <Text
                  style={[styles.phone, { color: theme.colors.textTertiary }]}
                >
                  📱 {profile.phone}
                </Text>
              )}
