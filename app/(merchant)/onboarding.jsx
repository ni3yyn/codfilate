  ...
  const finish = async () => {
    ...
    if (!selectedWilaya) {
      showAlert({
        title: "خطأ",
        message:
          "اختر ولاية عمل المتجر — المدير الإقليمي للولاية سيراجع ويفعّل حسابك.",
        type: "error",
      });
      return;
    }
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          أدخل بيانات متجرك وولاية النشاط. بعد الإنشاء، المدير الإقليمي للولاية
          سيوافق على تفعيل المتجر قبل ظهور منتجاتك للمسوقين.
        </Text>
        <Input
          label="اسم المتجر"
          value={name}
