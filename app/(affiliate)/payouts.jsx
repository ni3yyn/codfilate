...
export default function AffiliatePayouts() {
  ...
  useEffect(() => {
    if (Platform.OS !== 'web' || !showForm || typeof window === 'undefined') return;
  ...
  const handleRequest = async () => {
    ...
    if (!affiliateProfile?.id) {
      showAlert({
        title: "خطأ",
        message: "تعذر تحميل ملف المسوق. حاول لاحقاً.",
        type: "error",
      });
      return;
    }
        ...
        <View style={styles.ledgerInfo}>
          <View style={[styles.ledgerIconWrap, { backgroundColor: IconBg }]}>
            <Ionicons
              name={IconName}
              size={16}
              color={isIncome ? "#00B894" : theme.colors.textSecondary}
            />
          </View>
          <View style={styles.ledgerTextWrap}>
            <Text
              style={[styles.ledgerTitle, { color: theme.colors.text }]}
              numberOfLines={1}
            >
              {row.ledger_type === "affiliate_commission"
                ? "عمولة تسويق"
                : row.ledger_type === "payout"
                  ? "سحب أرباح"
                  : row.ledger_type}
            </Text>
            {!!row.ref_id && (
              <Text
                style={[styles.ledgerSub, { color: theme.colors.textTertiary }]}
              >
      ...
      <View style={styles.payoutHeader}>
        <View style={styles.payoutMethodRow}>
          ...
          >
            <Ionicons
              name={
                PAYOUT_METHODS.find((m) => m.id === item.method)?.icon ||
                "wallet-outline"
              }
              size={18}
          ...
          <View style={{ alignItems: "flex-end" }}>
            <Text
              style={[styles.payoutMethodName, { color: theme.colors.text }]}
            >
        ...
        {(item.admin_notes || item.external_ref || item.payout_proof_url) && (
          ...
          >
            ...
            {item.external_ref && (
              ...
              >
                <Ionicons name="receipt-outline" size={14} /> مرجع الدفع:{" "}
                {item.external_ref}
              </Text>
            )}
            {item.payout_proof_url && (
              ...
              >
                <Ionicons
                  ...
                  color={theme.primary}
                />
                <Text style={[styles.proofBtnText, { color: theme.primary }]}>
                  عرض إيصال الدفع
                </Text>
              </TouchableOpacity>
            )}
  ...
  const renderFormContent = () => (
    <View style={styles.formContainer}>
            ...
            >
              <View style={styles.methodIconRow}>
                ...
                <Ionicons
                  ...
                  size={20}
                  color={
                    isSelected ? theme.primary : theme.colors.textSecondary
                  }
                />
              </View>
              <Text
      ...
      {!details && (
        <View
          style={[styles.helperBox, { backgroundColor: theme.colors.surface2 }]}
        >
          <Text
  ...
  const renderWebOverlay = () => {
    ...
    return (
      <Modal transparent visible={showForm} animationType="none" onRequestClose={closeModal}>
          ...
          >
            ...
            <View style={styles.webModalHeaderRow}>
              ...
              <View style={styles.webModalHeaderTexts}>
                <Text
                  style={[styles.webModalTitle, { color: theme.colors.text }]}
                >
                  طلب سحب جديد
                </Text>
                <Text
                  style={[
                    styles.webModalSubtitle,
                    { color: theme.colors.textSecondary },
                  ]}
                >
                  سيتم مراجعة طلبك وتحويل المبلغ للطريقة المختارة
                </Text>
              </View>
            </View>
    ...
    >
      ...
      <View style={styles.centerWrapper}>
        ...
        >
          ...
          <View
            style={[styles.heroSection, isDesktop && styles.desktopHeroRow]}
          >
            <LinearGradient
              colors={gradients.primary}
              style={[
                styles.balanceCard,
                isDesktop && styles.desktopBalanceCard,
              ]}
              start={{ x: 0, y: 0 }}
              end={{ x: 1, y: 1 }}
            >
            ...
            >
              ...
              >
                ...
                <Text
                  style={[
                    styles.statValue,
                    { color: "#FDCB6E", writingDirection: "rtl" },
                  ]}
                >
              ...
              >
                ...
                <Text
                  style={[
                    styles.statValue,
                    { color: "#00B894", writingDirection: "rtl" },
                  ]}
                >
          ...
          <View style={isDesktop ? styles.desktopContentRow : null}>
            ...
            <View
              style={[
                ...
                isDesktop && styles.desktopHistoryCol,
              ]}
            >
            ...
            {ledger.length > 0 && (
              <View
                style={[
                  styles.sectionWrapper,
                  isDesktop && styles.desktopLedgerCol,
                ]}
              >
                <Text
                  ...
                  {ledger
                    ...
                    .map((row, index) =>
                      renderLedgerRow(
                        row,
                        index,
                        index === Math.min(ledger.length - 1, 7),
                      ),
                    )}
                </Card>
              </View>
